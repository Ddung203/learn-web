          ...
          <TabPanel>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              >
                <div class="space-y-3">
                  <div
                    v-for="(card, index) in weakCards.slice(0, 10)"
                    :key="index"
                    class="p-4 transition-all duration-200 border-2 border-red-200 rounded-lg bg-red-50 hover:shadow-md"
                  >
                    <div class="flex items-start justify-between mb-2">
                      <Chip
                        :label="'Card #' + card.card_id.substring(0, 8)"
                        class="text-xs"
                      />
                      <Tag
                        :value="Math.round(card.mastery_level) + '%'"
                        severity="danger"
                      />
                    </div>
                    <div class="flex items-center gap-3 mb-2">
                      <Badge
                        :value="card.times_studied + ' studied'"
                        severity="info"
                      />
                      <Badge
                        :value="card.times_correct + ' correct'"
                        severity="success"
                      />
                      <Badge
                        :value="card.times_incorrect + ' wrong'"
                        severity="danger"
                      />
                    </div>
                    <ProgressBar
              ...
              >
                <div class="space-y-3">
                  <div
                    v-for="(card, index) in masteredCards.slice(0, 10)"
                    :key="index"
                    class="p-4 transition-all duration-200 border-2 border-green-200 rounded-lg bg-green-50 hover:shadow-md"
                  >
                    <div class="flex items-start justify-between mb-2">
                      <Chip
                        :label="'Card #' + card.card_id.substring(0, 8)"
