    ...
    <div class="flex flex-col w-full px-5 lg:px-0 lg:max-w-4xl">
      ...
      >
        ...
        <p class="text-gray-500">
          {{ t('studyModes.test.noQuestionsDescription') }}
        </p>
      </div>
        ...
        <div class="mb-6">
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm font-medium text-gray-700">
              {{ t('studyModes.test.question') }} {{ progress.current }} /
              {{ progress.total }}
            </span>
                ...
                >
                  <div class="flex items-center justify-between">
                    ...
                    <i
                      ...
                      "
                      class="text-xl text-green-500 pi pi-check-circle"
                    ></i>
                    <i
                      v-if="
                        isSubmitted &&
          ...
          <Button
            ...
            :label="
              currentQuestionIndex === questions.length - 1
                ? t('studyModes.test.finish')
                : t('studyModes.test.nextQuestion')
            "
            @click="nextQuestion"
            size="large"
          />
